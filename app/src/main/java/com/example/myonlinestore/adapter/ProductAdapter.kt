package com.example.myonlinestore.adapter
...
import com.example.myonlinestore.R
import com.example.myonlinestore.models.Product

class ProductAdapter(private val productList: List<Product> = emptyList()): RecyclerView.Adapter<ProductAdapter.ProductViewHolder>() {
